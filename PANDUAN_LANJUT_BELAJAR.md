...
- **RENCANA SESI BERIKUTNYA (sebelum masuk jadwal SQL/OOP/Modular hari Senin 2026-08-31):** review dari NOL (predict-then-verify) 5 soal "TUGAS BESAR 2: Python Code / Logic" Sesi 1 (`RANGKUMAN_MODULE_1.md` baris ~1874-1917) — belum pernah dilatih sebagai kode konkret (beda dari self-test konsep Sesi 1 yang udah 90%):
  1. Program Konversi Suhu (Fahrenheit→Celsius, rumus `(F-32)*5/9`)
  2. Program Konversi Jarak (cm→km, format output string khusus `"1 km"`)
  3. Fungsi Cek Ganjil/Genap (return boolean; ada "anomali soal" — contoh minta format Rupiah tapi instruksi minta boolean, ikuti instruksi utama)
  4. Manipulasi String — hapus kemunculan PERTAMA sebuah kata (`"Hello world"` hapus `"ell"` pertama → `"Ho world"`)
  5. Cek Palindrome (`'madam'` → True)
  - **Alasan diprioritaskan:** pemanasan sebelum lanjut LeetCode (soal 4 & 5 pola umum di LeetCode Easy), sekaligus nutup gap "konsep solid tapi belum pernah coding-in konkret" khusus Sesi 1.
